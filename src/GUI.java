    ...
    public void start(Stage primaryStage) {
        try {
            ...
            shotController = new ShotController(
                    shots, tailPositions, wallHitPositions, players, fields, board, animatingPlayers,
                    playerShotAnim, hero_right, hero_left, hero_up, hero_down,
                    shot_Right, shot_Left, shot_Up, shot_Down, shot_Tail_Horizontal, shot_Tail_Vertical
            );
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                shotController.updateShots(GUI.this);
            }
        };
        timer.start();
    }
